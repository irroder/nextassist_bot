		...
		<div className="bg-[#000000] min-h-screen text-white p-4 relative max-w-[100vw] overflow-x-hidden font-sans">
			...
			<div className="flex justify-between items-center mb-6">
				...
				<div className="flex items-center gap-2">
					...
					/>
					<div className="flex items-center gap-1 bg-[#1c1c1c] px-2 py-1 rounded-lg cursor-pointer">
						{" "}
						{/* Фон темнее, скругление больше */}
			...
			<div className="bg-[#1c1c1c] rounded-xl p-4 flex items-center gap-3 mb-4 cursor-pointer">
				{" "}
				{/* Фон темнее, скругление больше */}
				...
				<div className="flex-grow">
					...
					<p className="text-xs text-gray-400">
						{" "}
						{/* Размер шрифта */}A collaborative project is created
						by adding the bot to a Telegram group
					</p>
				</div>
			...
			>
				<div className="button-content">
					<div
						className={`p-1.5 rounded-md ${
							showAddTask ? "bg-transparent" : "bg-[#1c1c1c]"
						}`}
					>
						<Plus className="text-gray-400 w-5 h-5 plus-icon" />
					</div>
				...
				<div className="form-content">
					...
					<div className="flex items-center justify-between bg-[#121212] p-2 rounded-lg">
						...
						<button className="bg-blue-500 text-white p-1.5 rounded-full w-7 h-7 flex items-center justify-center hover:bg-blue-600">
							<svg
			...
			{/* </AnimatePresence> */}{" "}
			{/* AnimatePresence больше не нужен для этой анимации */}
			{/* Список категорий */}
			<div className="bg-[#1c1c1c] rounded-xl p-1 space-y-0.5">
				{" "}
				{/* Уменьшен padding, добавлен space-y для тонких разделителей */}
				{categories.map((cat, i) => (
					...
					>
						<div className="flex items-center gap-3">
							<div
								className={`${cat.color} p-1.5 rounded-lg w-8 h-8 flex items-center justify-center`}
							>
								{" "}
								{/* Увеличен размер иконки, скругление */}
			...
			<div className="bg-[#1c1c1c] rounded-xl p-1 mt-4">
				{" "}
				{/* Отступ сверху */}
				<div className="flex items-center justify-between px-3 py-2.5 rounded-lg cursor-pointer hover:bg-[#2c2c2c] transition-colors">
					<div className="flex items-center gap-3">
						<div
							className={`bg-gray-700 p-1.5 rounded-lg w-8 h-8 flex items-center justify-center`}
						>
